 ...
 *
 */
public class BarcoDe3Casillas extends javax.swing.JFrame {

    /**
     * Creates new form BarcoDe3Casillas
     */
    public BarcoDe3Casillas() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ColumnaIngresada1 != ColumnaIngresada2 && ColumnaIngresada2 != ColumnaIngresada3 && FilaIngresada1 != FilaIngresada2 && FilaIngresada2 != FilaIngresada3) {
          ...
          l.SumaCont(cont);
            ...
            l.añadirPosicion(ColumnaIngresada1, FilaIngresada1, 3);
            l.añadirPosicion(ColumnaIngresada2, FilaIngresada2, 3);
            l.añadirPosicion(ColumnaIngresada3, FilaIngresada3, 3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BarcoDe3Casillas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BarcoDe3Casillas().setVisible(true);
            }
        });
    }
    int cont = 0;
